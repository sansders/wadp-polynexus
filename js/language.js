...
function setLanguage(language){
  if(language === 'jp'){
	...
	document.getElementById('setting3h3').innerHTML= "<i class='fa fa-user-times' aria-hidden='true'> 拉黑用户";
	...
	document.getElementById('setting4h3').innerHTML= "<i class='fa fa-paint-brush' aria-hidden='true'> 网页设计";
	...
	document.getElementById('setting5h3').innerHTML= "<i class='fa fa-globe' aria-hidden='true'> 语言";
	...
	document.getElementById('setting6h3').innerHTML= "<i class='fa fa-question' aria-hidden='true'> 图标";
